...
const BirthdayIcon = ({color}: Props) => {
	const iconColor = color ? color : 'whitesmoke';
			...
			<g clipPath="url(#_clip1)">
				...
				<g>
					<g>
						...
						/>
						<path
							d="M500,658.333l22.222,44.445l-44.444,0l22.222,-44.445Z"
							fill={iconColor}
						/>
					</g>
					<g>
						<path
							d="M325,550.926l25.926,51.852l-51.852,0l25.926,-51.852Z"
							fill={iconColor}
						/>
						<ellipse
							cx="325"
